    ...
    <div id="wrapper">
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion" id="accordionSidebar" style="background: rgb(158, 7, 7);">
            ...
            <li class="nav-item active">
                <a class="nav-link" href="../Paginas/Admin/cursos.php">
                    ...
                    <form
                        ...
                        <div class="input-group">
                            <div class="input-group-append" >
                                <h3 style="color: #000;">Cursos <small>modificaciones</small></h3>
                            </div>
                        </div>
                    </form>
                    <!-- Topbar Navbar -->
                                        ...
                                        <div class="tab-pane fade active in" id="new">
                                            ...
                                            <?php
                                                ...
                                                if(isset($_POST['actualizar']))
                                                {
                                                    ...
                                                    $NOM_CUR=trim($_POST['NOM_CUR']);

                                                    $consulta = "UPDATE cursos SET `NOM_CUR`= :NOM_CUR, `COD_CUR` = :COD_CUR WHERE `id` = :id";
                                                    
                                                    $sql = $con->prepare($consulta);
                                                    
                                                    $sql->bindParam(':NOM_CUR',$NOM_CUR,PDO::PARAM_STR, 25);
                                                    $sql->bindParam(':COD_CUR',$COD_CUR,PDO::PARAM_STR, 25);
                                                    $sql->bindParam(':id',$id,PDO::PARAM_INT);
                                                    ...
                                                    <form role="form" method="POST" action="<?php echo $_SERVER['PHP_SELF'] ?>">
                                                        ...
                                                        <div class="form-row">
                                                            <div class="form-group col-md-6">
                                                                <label for="NOM_CUR">Nombres</label>
                                                                <input value="<?php echo $obj->NOM_CUR;?>" name="NOM_CUR" type="text" class="form-control" placeholder="Nombre...">
                                                            </div>
                                                            <div class="form-group col-md-6">
                                                                <label for="COD_CUR">Codigo</label>
                                                                <input value="<?php echo $obj->COD_CUR;?>" name="COD_CUR" type="text" class="form-control" placeholder="Codigo...">
                                                            </div>
                                                        </div>
