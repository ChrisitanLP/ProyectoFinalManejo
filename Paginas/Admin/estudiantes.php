                                                        ...
                                                        <form action="../../Conexion/insertar.php" method="POST" enctype="multipart/form-data">
                                                            ...
                                                            <div class="form-group">
                                                                ...
                                                                <div>
                                                                    ...
                                                                    <input type="file" name="perfilE" title="seleccionar fichero" id="importData" accept=".jpg,.jpge, .png, .jfif, .svg" />
                                                                </div>
                                                            </div>
                                                            <p class="text-center">
                                        ...
                                        <div class="tab-pane fade" id="list">
                                            ...
                                            <center>
                                                <button type='button' class='btn btn-primary' style='color: #fff; background: rgb(231, 180, 40);'>
                                                    <a href='../../Conexion/modificarE.php' style='text-decoration: none; color: #fff;'>Editar Tabla</a>
                                                </button>
                                            </center>
                                        </div>
                                    </div>
